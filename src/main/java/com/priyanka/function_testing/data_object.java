...
public class data_object implements java.io.Serializable {
	...
	public data_object(java.lang.Number number1, java.lang.String field1,
			java.lang.String field2, int field3, int startIndex, int length,
			int brand, java.lang.String out_string,
			java.util.List<java.lang.String> list_str,
			java.lang.String output_any_contains) {
		this.number1 = number1;
		this.field1 = field1;
		this.field2 = field2;
		this.field3 = field3;
